...
public class ProfilPhotoUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /*
         * if(result>0) { if(status.equals("delete")) { File delFile = new
         * File(saveDirectory+oldFilepath); delFile.delete(); } request.setAttribute("result",
         * "성공임"); view.forward(request, response);
         * 
         * }else { request.setAttribute("result", "실패"); view.forward(request, response); }
         */
