...
public class Member {
    ...
    public Member(int memberNo, String memberId, String memberPw, String memberName,
            String memberBirth, String memberPhone, String memberAddr, String memberEmail,
            int memberGrade, String major, String enrollDate, int memberWarning, String memberPhoto,
            String doctorFilePath, String hospitalName, String hospitalAddr) {
        super();
