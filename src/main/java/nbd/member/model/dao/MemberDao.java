...
public class MemberDao {
    ...
    public int insertMember(Connection conn, Member member) {
        ...
        String query =
                "insert into member_tbl values(member_tbl_seq.nextval, ?, ?, ?, ?, ?, ?, ?, ?, to_char(sysdate,'yyyy-mm-dd'), 0, ?, ?, ?, ?, ?)";
    ...
    public ArrayList<DoctorReview> getMyReview(Connection conn, String memberId, int startNum,
            int endNum) {
        PreparedStatement pstmt = null;
        ResultSet rset = null;
    ...
    public ArrayList<Doctor> getMyHistory(Connection conn, String memberId) {
        // SELECT SUBSTR(DOCTOR_DATE, 0, 4) STARTYEAR, SUBSTR(DOCTOR_DATE, 5, 9) ENDYEAR,
        // DOCTOR_DATE, DOCTOR_WORK FROM DOCTOR_HISTORY_TBL WHERE DOCTOR_ID='DOC1' ORDER BY
        // DOCTOR_DATE DESC;
        PreparedStatement pstmt = null;
        ResultSet rset = null;
        ArrayList<Doctor> dlist = new ArrayList<Doctor>();
        String query =
                "SELECT SUBSTR(DOCTOR_DATE, 0, 4) STARTYEAR, SUBSTR(DOCTOR_DATE, 5, 9) ENDYEAR, DOCTOR_WORK FROM DOCTOR_HISTORY_TBL WHERE DOCTOR_ID=? ORDER BY DOCTOR_DATE DESC";
    ...
    public AdminInfo getAdminInfo(Connection conn) {
        ...
        AdminInfo ai = null;
        String query =
                "SELECT (SELECT COUNT(*) FROM MEMBER_TBL WHERE MEMBER_GRADE = 2) AS TOTAL_DOCTOR, ";
    ...
    public int updateMeberAddrPhone(Connection conn, String memberAddr, String memberPhone,
            int memberNo) {
    ...
    public MemberInfo getMemberPageTotal(Connection conn, int memberNo) {
        ...
        MemberInfo mi = null;
        String query =
                "SELECT (SELECT COUNT(*) FROM BOOK_TBL B WHERE B.MEMBER_NO=?) AS TOTAL_BOOK, "
    ...
    public int insertDoctorReview(Connection conn, String doctorId, String review, int bookNo,
            int memberNo, int star) {
        // 리뷰넘버, 의사아이디, 의사에대한 코멘트, 예약번호, 117, 4
        PreparedStatement pstmt = null;
        int result = 0;
        String query =
                "INSERT INTO DOCTOR_REVIEW_TBL VALUES (DOCTOR_REVIEW_SEQ.NEXTVAL, ?,?,?,?,?)";
