...
public class MyClinic {
    ...
    public MyClinic(int bookNo, String hospitalName, String doctorMajor, String bookDate,
            int pharmNo, String bookHistory, int bookPrice, int memberState, int memberNo,
            String doctorName, String pharmTitle, String pharmAddr, String pharmPhone) {
        super();
        this.bookNo = bookNo;
